...
- Migrations: Flyway
- Mapping: MapStruct
- Test: Spring Boot Starter Test, JUnit 5, AssertJ, Mockito
...
## Project Overview
A Java SpringBoot web application as a template for a snatdard SpringBoot webapp. 
The example is based on `Beer` and `Customer` models.
